...
{{-- @section('title',$administrateur->exists? "Modifier un administrateur":"Ajouter un administrateur") --}}
                                ...
                                <div class="row mb-1">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" disabled class="form-control   @error('nom') is-invalid @enderror" name="nom" placeholder="Votre nom" value="{{ old('nom',  $administrateur ? $administrateur->user->nom : '') }}" aria-label="nom" aria-describedby="addon-wrapping">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            <span class="input-group-text" id="addon-wrapping"><i class="mdi mdi-account"></i></span>
                                            <input type="text" disabled class="form-control @error('prenom') is-invalid @enderror" placeholder="votre prenom" name="prenom" aria-label="prenom" value="{{ old('prenom', $administrateur ? $administrateur->user->prenom : '') }}" aria-describedby="addon-wrapping">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" disabled class="form-control @error('adresse') is-invalid @enderror" name="adresse" placeholder="votre adresse" aria-label="adresse" value="{{ old('adresse', $administrateur ? $administrateur->user->adresse : '') }}" aria-describedby="addon-wrapping">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" disabled class="form-control @error('telephone') is-invalid @enderror" placeholder="votre telephone" aria-label="telephone" name="telephone" value="{{ old('telephone', $administrateur ? $administrateur->user->telephone : '') }}" aria-describedby="addon-wrapping">
                    ...
                    <div class="card-body">
                                        ...
                                        <div class="">
                                            <div class="">
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <input type="text" disabled class="form-control @error('name') is-invalid @enderror" name="name" placeholder="votre name" aria-label="name" aria-describedby="addon-wrapping" value="{{ old('name', $administrateur ? $administrateur->user->name : '') }}" ><br>
                                        ...
                                        <div class="">
                                            <div class="">
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <input type="text" disabled class="form-control @error('email') is-invalid @enderror" placeholder="votre email" name="email" aria-label="email" aria-describedby="addon-wrapping" value="{{ old('email', $administrateur ? $administrateur->user->email : '') }}" ><br>
                                    ...
                                    <div class="row">
                                        <div class=" mt-2">
                                            <label for="statut" class="custom-switch-label m-0">
                                                {{ $administrateur->user->statut ? 'Actif' : 'Inactif' }}
                                            </label>

                                            <div class="col-md-4 position-relative">
                                                <label class="custom-switch m-0">
                                                    {{-- <input type="checkbox" id="statut"  class="custom-switch-input   @error('plublier') is-invalid @enderror"  id="plublierFloating" name="statut" value="{{ old('statut', $administrateur->user->statut)}} {{ $administrateur->user->statut ? 'checked' : '' }}"> --}}
                                                    <input type="checkbox" id="statut" class="custom-switch-input @error('plublier') is-invalid @enderror" id="plublierFloating" name="statut" {{ old('statut', $administrateur->user->statut) ? 'checked' : '' }}>
                        ...
                        <div class="card-footer text-center">
                            ...
                            <button class="btn btn-primary" type="submit">
                                ...
                                {{ $administrateur->user->statut ? ' Desactivation du Compte' : ' Activation du Compte' }}
